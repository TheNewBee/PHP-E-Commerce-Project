...
<body>
    ...
    <fieldset class="border border-dark rounded">
        ...
        <form class="form-group" id="user_change_pw" method="POST" action="/php/userRegister.php">
            ...
            <div> <input class="form-control" type="password" placeholder="password" name="password" required="required"/></div>
